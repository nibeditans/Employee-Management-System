...
5. Execute the script by running: `python employee_management_system.py`
...
This project is freely available for free use and modification under the terms of the MIT License. See the [LICENSE](LICENSE) file for details.
